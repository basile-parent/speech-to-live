jest.mock('./specs/NativeSpeechRecognition', () => ({
  ...
  default: {
    ...
    getRecognitionModels: jest.fn(async () => []),
    setRecognitionModel: jest.fn(async () => undefined),
    downloadRecognitionModel: jest.fn(async () => undefined),
    deleteRecognitionModel: jest.fn(async () => undefined),
    addListener: jest.fn(),
